//
// Created by yarkoe on 17.12.2020.
//
...
TCPServer::TCPServer(unsigned short port) {
    ...
    ExitIfTrue(bind(serverSocket, (struct sockaddr *)&tcpServerAddr, sizeof(tcpServerAddr)) < 0, "Binding failed");
}
...
Client TCPServer::AcceptNewClient() {
    ...
    int serverAddressLen = sizeof(tcpServerAddr);
    ExitIfTrue((clientSocket = accept(serverSocket, (struct sockaddr *)&tcpServerAddr, (socklen_t*)&serverAddressLen)) < 0, "Accept failed");
